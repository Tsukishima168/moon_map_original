...
- **目的地**：直接發送到 Discord #月島訂單通知 頻道（ID: `1467024414699819152`）
- **不會重定向到 results 頻道**：訂單完成後只會重定向到 LINE 訊息或桌面成功頁面

### Discord API 實現（api/notify-discord-order.ts）
- ✅ **頻道ID**：`1467024414699819152` (月島訂單通知頻道，非 results)
- ✅ **伺服器ID**：`1451819433432580202` (Kiwimu宇宙，非頻道 ID)
...
- **Discord API 版本**：v10
- **Discord 伺服器 / Guild ID**：1451819433432580202
- **月島訂單通知頻道 ID**：1467024414699819152
