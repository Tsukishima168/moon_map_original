...
2. **本機 canonical repo 路徑**
   - Local Path: `/Users/pensoair/Desktop/Web-Projects/sites/map-kiwimu-com`
...
2. 找到對應 `map.kiwimu.com` 的 Vercel 專案（目前專案名可能仍是 `moon-map-original`）
3. 查看最新的部署狀態
...
- **Local Canonical Path**: `/Users/pensoair/Desktop/Web-Projects/sites/map-kiwimu-com`
